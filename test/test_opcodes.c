...
void test_op_artithmetic(void)
{
   ...
   emu.cpu.A = 0x80;
   emu.cpu.B = 0x01;
   cpu_debug_run_opcode(&emu.cpu, OP_ADD_A_B);
   ...
   emu.cpu.A = 0x80;
   emu.cpu.C = 0xFF;
   cpu_debug_run_opcode(&emu.cpu, OP_ADD_A_C);
   ...
   cpu_debug_run_opcode(&emu.cpu, OP_ADD_A_N);
   ...
   emu.cpu.HL = 0x0FFF;
   emu.cpu.DE = 0x0001;
   cpu_debug_run_opcode(&emu.cpu, OP_ADD_HL_DE);
   ...
   emu.cpu.A = 0x10;
   emu.cpu.B = 0x05;
   cpu_debug_run_opcode(&emu.cpu, OP_SUB_A_B);
   ...
   cpu_debug_run_opcode(&emu.cpu, OP_SUB_A_N);
   ...
   cpu_debug_run_opcode(&emu.cpu, OP_SBC_A_C);
   TEST_ASSERT_EQUAL_HEX(0x10, emu.cpu.A);
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_Z(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x1 , READ_N(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_H(emu.cpu.F));
   ...
   emu.cpu.A = 0xFF;
   emu.cpu.B = 0x0F;
   cpu_debug_run_opcode(&emu.cpu, OP_AND_A_B);
   TEST_ASSERT_EQUAL_HEX(0x0F, emu.cpu.A);
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_Z(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_N(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x1 , READ_H(emu.cpu.F));
   ...
   cpu_debug_run_opcode(&emu.cpu, OP_AND_A_N);
   ...
   emu.cpu.A = 0xFF;
   emu.cpu.C = 0x0F;
   cpu_debug_run_opcode(&emu.cpu, OP_XOR_A_C);
   TEST_ASSERT_EQUAL_HEX(0xF0, emu.cpu.A);
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_Z(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_N(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_H(emu.cpu.F));
   ...
   cpu_debug_run_opcode(&emu.cpu, OP_XOR_A_N);
   ...
   emu.cpu.A = 0x0F;
   emu.cpu.D = 0xF0;
   cpu_debug_run_opcode(&emu.cpu, OP_OR_A_D);
   TEST_ASSERT_EQUAL_HEX(0xFF, emu.cpu.A);
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_Z(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_N(emu.cpu.F));
   TEST_ASSERT_EQUAL_HEX(0x0 , READ_H(emu.cpu.F));
   ...
   cpu_debug_run_opcode(&emu.cpu, OP_OR_A_N);
   ...
   emu.cpu.A = 0x20;
   emu.cpu.E = 0x10;
   cpu_debug_run_opcode(&emu.cpu, OP_CP_A_E);
   ...
   cpu_debug_run_opcode(&emu.cpu, OP_CP_A_N);
