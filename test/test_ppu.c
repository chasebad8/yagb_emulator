...
void test_ppu_get_tile_pixel_color_id( void )
{
   ...
   emu.ppu.vram[0x8010 - 0x8000] = 0x3C;
   emu.ppu.vram[0x8011 - 0x8000] = 0x00;
   emu.ppu.vram[0x8012 - 0x8000] = 0x42;
   emu.ppu.vram[0x8013 - 0x8000] = 0x00;
   emu.ppu.vram[0x8014 - 0x8000] = 0xA9;
   emu.ppu.vram[0x8015 - 0x8000] = 0x00;
   emu.ppu.vram[0x8016 - 0x8000] = 0x81;
   emu.ppu.vram[0x8017 - 0x8000] = 0x00;
   emu.ppu.vram[0x8018 - 0x8000] = 0xA5;
   emu.ppu.vram[0x8019 - 0x8000] = 0x00;
   emu.ppu.vram[0x801A - 0x8000] = 0x81;
   emu.ppu.vram[0x801B - 0x8000] = 0x00;
   emu.ppu.vram[0x801C - 0x8000] = 0x42;
   emu.ppu.vram[0x801D - 0x8000] = 0x00;
   emu.ppu.vram[0x801E - 0x8000] = 0x3C;
   emu.ppu.vram[0x801F - 0x8000] = 0x00;
